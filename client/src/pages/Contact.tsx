            ...
            <CardContent className="pt-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-foreground">Indian Institute of Technology Delhi</p>
                    <p className="text-muted-foreground">Hauz Khas, New Delhi</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-foreground">contact@deeplure.ai</p>
                </div>
                
                <div className="flex items-center gap-3">
                  <Phone className="h-5 w-5 text-secondary flex-shrink-0" />
                  <p className="text-foreground">+91 11 2659 1000</p>
                </div>
              </div>
            </CardContent>
          </Card>
